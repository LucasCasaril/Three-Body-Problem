...
def rkf_integration(dydt, t0, tf, y0, G, m1, m2, m3, tol, h):
     ...
     while t < tf:
          ...
          k1 = h * dydt(t, y, G, m1, m2, m3)
          k2 = h * dydt(t + h/4, y + k1/4, G, m1, m2, m3)
          k3 = h * dydt(t + (3*h)/8, y + (3*k1)/32 + (9*k2)/32, G, m1, m2, m3)
          k4 = h * dydt(t + (12*h)/13, y + (1932*k1)/2197 - (7200*k2)/2197 + (7296*k3)/2197, G, m1, m2, m3)
          k5 = h * dydt(t + h, y + (439*k1)/216 - 8*k2 + (3680*k3)/513 - (845*k4)/4104, G, m1, m2, m3)
          k6 = h * dydt(t + h/2, y - (8*k1)/27 + 2*k2 - (3544*k3)/2565 + (1859*k4)/4104 - (11*k5)/40, G, m1, m2, m3)
